    ...
    //ctor
     ...
     bc_include = new bool [total_nodes +1];
      ...
      v = new double [total_nodes +1];
        ...
        normal_x = new double [total_nodes +1];
        if (normal_x==NULL) exit (1);
        normal_y = new double [total_nodes +1];
        if (normal_y==NULL) exit (1);
        normal_z = new double [total_nodes +1];
        if (normal_z==NULL) exit (1);
